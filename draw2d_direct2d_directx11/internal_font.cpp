...
namespace draw2d_direct2d_directx11
{
   ...
   void internal_font::on_create_font(::draw2d::graphics * pgraphics, ::write_text::font * pfont)
   {
      ...
      ::cast < ::draw2d_direct2d_directx11::font> pdraw2ddirect2d_directx11font = pfont;

      IDWriteFactory * pfactory = ::direct2d_directx11::dwrite_factory();

      ::wstring wstrFamilyName;

      pdraw2ddirect2d_directx11font->m_pcollection = m_pcollection;

      if (pdraw2ddirect2d_directx11font->::write_text::font::m_pfontfamily->m_strFamilyName.has_character())
      {

         wstrFamilyName = pdraw2ddirect2d_directx11font->::write_text::font::m_pfontfamily->m_strFamilyName;
      ...
      else
      {
         ...
         auto & pdwritefontfamily = pdraw2ddirect2d_directx11font->m_pfamily;
      ...
      auto weight = pdraw2ddirect2d_directx11font->_dwrite_font_weight();
      auto style = pdraw2ddirect2d_directx11font->_dwrite_font_style();
      auto stretch = pdraw2ddirect2d_directx11font->_dwrite_font_stretch();
      auto size = pdraw2ddirect2d_directx11font->_dwrite_font_size(pgraphics);
      ...
      HRESULT hr = pfactory->CreateTextFormat(
         ...
         size,
         L"",
         &pdraw2ddirect2d_directx11font->m_pformat);
      ...
      //auto & pfamily = pdraw2ddirect2d_directx11font->m_pfamily;
      ...
      //      if (strName == pdraw2ddirect2d_directx11font->m_pfontfamily->m_strFamilyName)
      //      {
      ...
      //         pdraw2ddirect2d_directx11font->_dwrite_font_weight(),
      //         pdraw2ddirect2d_directx11font->_dwrite_font_stretch(),
      //         pdraw2ddirect2d_directx11font->_dwrite_font_style(),
      //         &pdwritefont);
