...
namespace draw2d_direct2d_directx11
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 path :
      virtual public ::draw2d_direct2d_directx11::object,
   ...
   public:
      ...
      virtual bool internal_add_string(::draw2d_direct2d_directx11::graphics * pgraphics, double x, double y, const ::string & strText, ::write_text::font * pfont);
