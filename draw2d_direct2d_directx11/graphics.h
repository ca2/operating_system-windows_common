...
#include "direct2d_directx11/graphics.h"
...
namespace draw2d_direct2d_directx11
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 graphics :
      virtual public ::draw2d_gpu::graphics
      , virtual public ::direct2d_directx11::graphics
   {
   public:
...
//      virtual Gdiplus::FillMode direct2d_directx11_get_fill_mode() override;
...
//      virtual void set_direct2d_directx11_plugin(::draw2d_direct2d_directx11::plugin * pplugin);
//#endif
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 layer
   {
   public:
