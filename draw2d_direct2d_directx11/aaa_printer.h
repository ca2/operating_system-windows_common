...
namespace draw2d_direct2d_directx11
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 printer :
      virtual public ::aura::printer
   {
   public:


      class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 document_properties :
      ...
      public:
         ...
         virtual bool initialize(::draw2d_direct2d_directx11::printer * pprinter, DEVMODE * pdevmode = nullptr);
         virtual bool close();
