...
#include "direct2d_directx11/geometry.h"
...
namespace draw2d_direct2d_directx11
{
      ...
      m_pgpucontext->_send([this, size]()
         {
            ...
            /*::direct2d_directx11::direct2d_directx11() = __allocate ::draw2d_direct2d_directx11::plugin();

            ::direct2d_directx11::get()->initialize();*/
            ...
            ::direct2d_directx11_lock lock;

            auto pdirect2d_directx11 = ::direct2d_directx11::get();

            auto pdevicecontextDefault = pdirect2d_directx11->default_d2d1_device_context(pwindow, rectanglePlacement);
   ...
   bool graphics::_draw_blend(const ::image::image_drawing & imagedrawing)
   {
      ...
      //      ::pointer<::draw2d_direct2d_directx11::graphics>pgraphicsDib1 = pimage1->get_graphics();

      //      ::pointer<::draw2d_direct2d_directx11::graphics>pgraphicsDib2 = pimage2->get_graphics();
   ...
   void graphics::set(::draw2d::bitmap * pbitmapParam)
   {
      ...
      ::pointer<::draw2d_direct2d_directx11::bitmap>pbitmap = pbitmapParam;
      ...
      //{
         ...
         //::pointer<::draw2d_direct2d_directx11::graphics>pgraphicsMap = m_pgraphicsMap;

         //::pointer<::draw2d_direct2d_directx11::graphics>pgraphics = m_pgraphics;

         //::pointer<::draw2d_direct2d_directx11::bitmap>pbitmap = m_pbitmap;
...
//
   ...
   void graphics::fill_ellipse(const ::double_rectangle & rectangle)
   {
      ...
      if (m_pbrush->m_ebrush == ::draw2d::e_brush_box_gradient)
      {
         ...
         //HRESULT hr = ::direct2d_directx11::factory()->CreatePathGeometry(&pgeometry);
   ...
   void graphics::draw_rectangle(const ::double_rectangle & rectangleParam, ::draw2d::pen * ppen)
   {
      ...
      ::draw2d_direct2d_directx11::pen * ppen2 = dynamic_cast <::draw2d_direct2d_directx11::pen *> (ppen);
   ...
   void graphics::fill_rectangle(const ::double_rectangle & rectangleParam, ::draw2d::brush * pbrush)
   {
      ...
      ::draw2d_direct2d_directx11::brush * pbrush2 = dynamic_cast <::draw2d_direct2d_directx11::brush *> (pbrush);
   ...
   void graphics::fill_round_rectangle(const ::double_rectangle & rectangleParam, ::draw2d::brush * pbrush, double dRadius)
   {
      ...
      if (m_pbrush.is_set() && m_pbrush->m_ebrush != ::draw2d::e_brush_null)
      {
         ...
         auto pbrush = m_pbrush.cast <::draw2d_direct2d_directx11::brush >();
   ...
   void graphics::draw_round_rectangle(const ::double_rectangle & rectangleParam, ::draw2d::pen * ppen, double dRadius)
   {
      ...
      if (m_ppen.is_set() && m_ppen->m_epen != ::draw2d::e_pen_null)
      {
         ...
         auto ppen = m_ppen.cast <::draw2d_direct2d_directx11::pen >();
   ...
   void graphics::_stretch_raw(const ::double_rectangle & rectangleTarget, ::image::image * pimage, const ::image::image_drawing_options & imagedrawingoptions, const ::double_rectangle & rectangleSource)
   {
      ...
      //   output_debug_string("direct2d_directx11 graphics::StretchBltRaw hr failed");
   ...
   void graphics::fill_path()
   {
      ...
      //return m_prendertarget->FillPath(direct2d_directx11_brush(), m_ppath) == Gdiplus::Status::Ok;
   ...
   void graphics::stroke_and_fill_path()
   {
      ...
      //bool bOk1 = m_prendertarget->FillPath(direct2d_directx11_brush(), m_ppathPaint) == Gdiplus::Status::Ok;

      //bool bOk2 = m_prendertarget->DrawPath(direct2d_directx11_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::stroke_path()
   {
      ...
      //      return m_prendertarget->DrawPath(direct2d_directx11_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   ...
   void graphics::widen_path()
   {
      ...
      //      return m_ppath->Widen(direct2d_directx11_pen()) == Gdiplus::Status::Ok;
   ...
   //      //dynamic_cast <::draw2d_direct2d_directx11::graphics *> (pgraphicsSrc)->SaveClip();
   ...
   //         //dynamic_cast <::draw2d_direct2d_directx11::graphics *> (pgraphicsSrc)->RestoreClip();
...
//   {
   ...
   //   ::direct2d_directx11::factory()->CreateRectangleGeometry(r, &pgeometry);
   ...
   //      auto pgeometry = ::direct2d_directx11::geometry::create_ellipse(ellipse);
   ...
   void graphics::intersect_clip(const ::draw2d::clip_group & clipgroup)
   {
      ...
      HRESULT hr = ::direct2d_directx11::factory()->CreatePathGeometry(&ppathgeometry);
   ...
   void graphics::_add_clip_item(ID2D1GeometrySink * pgeometrysink, ::draw2d::clip_item * pclipitem)
   {
      ...
      case ::draw2d::e_clip_item_rectangle:
         ::direct2d_directx11::geometry::add_rectangle(pgeometrysink, dynamic_cast<::draw2d::clip_rectangle *>(pclipitem)->m_item);
         break;
      case ::draw2d::e_clip_item_ellipse:
         ::direct2d_directx11::geometry::add_ellipse(pgeometrysink, dynamic_cast<::draw2d::clip_ellipse *>(pclipitem)->m_item);
         break;
      case ::draw2d::e_clip_item_polygon:
         ::direct2d_directx11::geometry::add_polygon(pgeometrysink, dynamic_cast<::draw2d::clip_polygon *>(pclipitem)->m_item);
         break;
      default:
         break;
      };
   ...
   //      //auto pellipsegeometry = ::direct2d_directx11::geometry::;

   //      auto pgeometry = ::direct2d_directx11::geometry::create_polygon(polygon);
                                           ...
                                           HANDLETABLE * pHandleTable, METARECORD * pMetaRec, double dHandles, LPARAM lParam)
   {
      ...
      case META_SETMAPMODE:
         //(dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->SetMapMode((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWEXT:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->set_window_ext(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWORG:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->SetWindowOrg(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTEXT:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->set_extents(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTORG:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->set_origin(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEWINDOWEXT:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->scale_window_ext(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEVIEWPORTEXT:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->scale_extents(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_OFFSETVIEWPORTORG:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->offset_origin(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SAVEDC:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->save_graphics_context();
         break;
      case META_RESTOREDC:
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->restore_graphics_context((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETBKCOLOR:
      {
         ...
         (dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphics))->set(pbrush);
      ...
      case META_SELECTOBJECT:
      {
         ...
         if (nObjType == 0)
         {
            ...
            //HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->get_handle1(), hStockFont);
            //HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->get_handle1(), hObject);
            //if (hObjOld == hStockFont)
            //{
            //   // got the stock object back, so must be selecting a font
            //   throw ::not_implemented();
            //   //                  (dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->SelectObject(::draw2d_direct2d_directx11::font::from_handle_dup(pgraphics->get_application(), (HFONT)hObject));
            //   break;  // don't play the default record
            //}
            //else
            //{
            //   // didn't get the stock object back, so restore everything
            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->get_handle1(), hFontOld);
            //   ::SelectObject((dynamic_cast<::draw2d_direct2d_directx11::graphics * >(pgraphics))->get_handle1(), hObjOld);
            //}
   ...
   double_size graphics::get_text_extent(const ::scoped_string & scopedstr, character_count iIndex)
   {
      ...
      hr = ::direct2d_directx11::dwrite_factory()->CreateTextLayout(
   ...
   void graphics::draw_line(double x1, double y1, double x2, double y2, ::draw2d::pen * ppen)
   {
      ...
      m_prendertarget->DrawLine(p1, p2, pbrush, (FLOAT)(dynamic_cast <::draw2d_direct2d_directx11::pen *> (m_ppen.m_p))->m_dWidth);
   ...
   void graphics::line_to(double x, double y)
   {
      ...
      FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_direct2d_directx11::pen *> (m_ppen.m_p))->m_dWidth;
   ...
   //                                            );
   //
   //      HRESULT hr = ::direct2d_directx11::factory()->CreateDCRenderTarget(&props,&m_pdcrendertarget);
   //
   //      if (FAILED(hr))
   //      {
   //
   ...
   bool graphics::draw(const ::write_text::text_out & textout, ::draw2d::pen * ppen)
   {
      ...
      //IDWriteFactory * pfactory = ::direct2d_directx11::dwrite_factory();
      ...
      //CustomTextRenderer renderer(::direct2d_directx11::factory(),m_prendertarget,ppen->get_os_data < ID2D1Brush * >(this));
   ...
   bool graphics::fill(const ::write_text::text_out & textout, ::draw2d::brush * pbrush)
   {
      ...
      //   CustomTextRenderer renderer(::direct2d_directx11::factory(), m_prendertarget, nullptr, posbrush);
   ...
   //void graphics::set_direct2d_directx11_plugin(::draw2d_direct2d_directx11::plugin * pplugin)
   //{

   //   ::direct2d_directx11::direct2d_directx11() = pplugin;
   ...
   ID2D1Geometry * graphics::defer_update_os_data(::pointer < ::geometry2d::region > & pregion)
   {
      ...
      ::pointer < region > pdirect2d_directx11region = pregion;

      if (!pdirect2d_directx11region)
      {

         pdirect2d_directx11region = __create_new < region >();

         //pdirect2d_directx11region->m_eregion = pregion->m_eregion;

         pdirect2d_directx11region->m_pitem = pregion->m_pitem;

         pregion = pdirect2d_directx11region;

      }

      return (ID2D1Geometry *)pdirect2d_directx11region->get_os_data(this);
