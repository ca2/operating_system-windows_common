...
namespace draw2d_direct2d_directx11
{
   ...
   //class CLASS_DECL_DRAW2D_DIRECT2D_DIRECTX11 swap_chain_end_draw :
   ...
   void swap_chain_end_draw::initialize_end_draw(::draw2d_gpu::graphics* pgraphics)
   {
      ...
      m_pd2d1devicecontext = ::direct2d_directx11::get()->create_d2d1_device_context(nullptr, {});
      ...
      //m_pd2d1device = pdirect2d_directx11->d2d1_device(pwindow, rectanglePlacement);
