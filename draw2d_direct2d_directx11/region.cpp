...
namespace draw2d_direct2d_directx11
{
   ...
   ID2D1Geometry * region::get_rectangle(::draw2d::graphics* pgraphicsParam)
   {
      ...
      auto prectanglegeometry = ::direct2d_directx11::geometry::create_rectangle(pitem->m_item);
   ...
   ID2D1Geometry * region::get_ellipse(::draw2d::graphics* pgraphics)
   {
      ...
      //::direct2d_directx11::factory()->CreateEllipseGeometry(ellipse, &pgeometry);

      auto pellipsegeometry = ::direct2d_directx11::geometry::create_ellipse(pitem->m_item);
   ...
   ID2D1Geometry * region::get_polygon(::draw2d::graphics* pgraphics)
   {
      ...
      */
      ...
      auto ppathgeometry = ::direct2d_directx11::geometry::create_polygon(pitem->m_polygon);
   ...
   ID2D1Geometry * region::get_combine(::draw2d::graphics* pgraphics)
   {
      ...
      ::pointer < graphics > pdirect2d_directx11graphics = pgraphics;

      auto pgeometry1 = pdirect2d_directx11graphics->defer_update_os_data(pitem->m_pregion1);

      auto pgeometry2 = pdirect2d_directx11graphics->defer_update_os_data(pitem->m_pregion2);
