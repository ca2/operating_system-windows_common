...
namespace draw2d_direct2d_directx11
{
   ...
   bool image::_create(::draw2d::graphics* pgraphicsParam)
   {
      ...
      ::draw2d::bitmap * pbitmap = dynamic_cast<::draw2d_direct2d_directx11::graphics *>(pgraphicsParam)->get_current_bitmap();
...
//#endif
   ...
   void image::_map(bool bApplyAlphaTransform)
   {
      ...
      auto pgraphics2d = m_pgraphics.cast < ::draw2d_direct2d_directx11::graphics>();
   ...
   void image::blend(const ::int_point & pointDst, ::image::image * pimageSrc, const ::int_point & pointSrc, const ::int_size & sizeParam, unsigned char bA)
   {
      ...
      //   ::draw2d_direct2d_directx11::graphics * pgraphics = dynamic_cast <::draw2d_direct2d_directx11::graphics *> (get_graphics());
      ...
      //      //dynamic_cast <::draw2d_direct2d_directx11::graphics *> (pgraphicsMap)->RestoreClip();
