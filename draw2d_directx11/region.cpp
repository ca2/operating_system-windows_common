...
namespace draw2d_directx11
{
   ...
   //   auto prectanglegeometry = ::directx11::geometry::create_rectangle(m_pdirectx11, pitem->m_item);
   ...
   //   //m_pdirectx11->d2d1_factory1()->CreateEllipseGeometry(ellipse, &pgeometry);

   //   auto pellipsegeometry = ::directx11::geometry::create_ellipse(m_pdirectx11,pitem->m_item);
