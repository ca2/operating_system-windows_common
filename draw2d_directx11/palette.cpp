...
//   {
//      //ASSERT(pgraphics != nullptr && (dynamic_cast<::draw2d_directx11::graphics * >(pgraphics))->get_handle1() != nullptr);
//      //return Attach(::CreateHalftonePalette((dynamic_cast<::draw2d_directx11::graphics * >(pgraphics))->get_handle1()));
//      return false;
//
//   }
