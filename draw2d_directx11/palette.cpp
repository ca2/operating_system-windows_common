...
//   {
//      //ASSERT(pdraw2dgraphics != nullptr && (dynamic_cast<::draw2d_directx11::graphics * >(pdraw2dgraphics))->get_handle1() != nullptr);
//      //return Attach(::CreateHalftonePalette((dynamic_cast<::draw2d_directx11::graphics * >(pdraw2dgraphics))->get_handle1()));
//      return false;
//
//   }
