...
namespace draw2d_directx11
{
   ...
   public:
      ...
      virtual bool internal_add_string(::draw2d_directx11::graphics * pdraw2dgraphics, ::f64 x, ::f64 y, const ::scoped_string & scopedstrText, ::write_text::font * pwritetextfont);
