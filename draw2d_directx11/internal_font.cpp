...
namespace draw2d_directx11
{
   ...
   void internal_font::on_create_font(::draw2d::graphics * pdraw2dgraphics, ::write_text::font * pwritetextfont)
   {
      ...
      ::cast < ::draw2d_directx11::font> pdraw2ddirectx11font = pwritetextfont;

      //IDWriteFactory * pfactory = m_pdirectx11->dwrite_factory();

      //::wstring wstrFamilyName;

      //pdraw2ddirectx11font->m_pcollection = m_pcollection;

      //if (pdraw2ddirectx11font->::write_text::font::m_pfontfamily->m_strFamilyName.has_character())
      //{

      //   wstrFamilyName = pdraw2ddirectx11font->::write_text::font::m_pfontfamily->m_strFamilyName;
      ...
      //   auto & pdwritefontfamily = pdraw2ddirectx11font->m_pfamily;
      ...
      //auto weight = pdraw2ddirectx11font->_dwrite_font_weight();
      //auto style = pdraw2ddirectx11font->_dwrite_font_style();
      //auto stretch = pdraw2ddirectx11font->_dwrite_font_stretch();
      //auto size = pdraw2ddirectx11font->_dwrite_font_size(pdraw2dgraphics);
      ...
      //   size,
      //   L"",
      //   &pdraw2ddirectx11font->m_pformat);
      ...
      //auto & pfamily = pdraw2ddirectx11font->m_pfamily;
      ...
      //      if (strName == pdraw2ddirectx11font->m_pfontfamily->m_strFamilyName)
      //      {
      ...
      //         pdraw2ddirectx11font->_dwrite_font_weight(),
      //         pdraw2ddirectx11font->_dwrite_font_stretch(),
      //         pdraw2ddirectx11font->_dwrite_font_style(),
      //         &pdwritefont);
