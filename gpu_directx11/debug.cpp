...
//
//
//         // The return value of this callback controls whether the DirectX11 call that caused the validation message will be aborted or not
//         // We return VK_FALSE as we DON'T want DirectX11 calls that cause a validation message to abort
