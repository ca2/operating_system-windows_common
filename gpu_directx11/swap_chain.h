...
namespace gpu_directx11
{
   ...
   public:
...
#endif
      /* Set the DirectX11 objects required for swapchain creation and management, must be called before swapchain creation */
      ...
      */
      ...
      /* Free all DirectX11 resources acquired by the swapchain */
      void cleanup();
