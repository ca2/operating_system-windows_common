...
void context_fbo::on_initialize_particle()
{
   ...
   ::directx11::context::on_initialize_particle();
  ...
  // {
   ...
   void context_fbo::_create_offscreen_buffer(const ::int_size & sizeParam)
   {
      ...
      this->post([this, size]()
         ...
         ::pointer<directx11>pdirectx11 = pgpu;
         
         if (::is_null(pdirectx11))
         {
         ...
         CGLPixelFormatAttribute AttribList[] =
         {
            ...
            //         kCGLPFADirectX11Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            ...
            //
            //kCGLPFADirectX11Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL4_Core,
            kCGLPFADirectX11Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            //         kCGLPFADirectX11Profile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_2_Core,
         ...
         //auto displayMask= CGDisplayIDToDirectX11DisplayMask (display);
