...
//
  ...
  //      if (callback)
   ...
   //      m_psetdescriptorlayoutImageBlend = ::gpu_directx11::set_descriptor_layout::Builder(m_pgpucontext)
   //         .addBinding(0, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, VK_SHADER_STAGE_FRAGMENT_BIT)
   //         .build();
...
///pcontext->g_pImmediateContext->OMSetRenderTargets(1, rtv.GetAddressOf(), nullptr);
   ...
   ::pointer < ::gpu::frame > renderer::beginFrame()
   {
      ...
      //      throw ::exception(error_failed, "failed to begin recording command buffer!");
      //   }
        //auto pframe = __create_new < ::gpu_directx11::frame >();
      //   pframe->commandBuffer = commandBuffer;
   ...
   void renderer::endFrame()
   {
      ...
      ////currentFrameIndex = (currentFrameIndex + 1) % ::gpu_directx11::render_target_view::MAX_FRAMES_IN_FLIGHT;
   ...
   //void renderer::_on_frame_draw(::gpu_directx11::renderer* prendererUpper)
   //{
