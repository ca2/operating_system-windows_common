...
namespace gpu_directx11
{
   ...
   public:
      ...
      //VkQueue                          m_vkqueue;
      //// Depth buffer format (selected during DirectX11 initialization)
...
//      ::array<VkFence>                 m_fencewaita;
      ...
      /** @brief Encapsulated physical and logical directx11 device */
      ...
      ::string m_strTitle = "DirectX11 Example";
      ::string m_strName = "directx11Example";
...
//#endif
      ...
      //__creatable_from_base(directx11, ::gpu::approach);
