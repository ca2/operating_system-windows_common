...
//
//		pgpudevice->m_pd3d11device->CreateTexture2D(&texDesc, nullptr, &m_ptextureShared);
//		//m_bNeedRebuild = false;
//	   //init();
...
//
//				//::cast < ::gpu_directx11::swap_chain_render_target_view > pswapchainrendertargetview = pgpurenderer->m_prendertargetview;
//
//		HRESULT hr = pgpudevice->m_pd3d11device->CreateShaderResourceView(
...
//		);
//		if (FAILED(hr)) {
//			if (errorBlob) OutputDebugStringA((::i8*)errorBlob->GetBufferPointer());
//			return;
//		}
//
//		// Pixel Shader
...
//		}
//
//		pgpudevice->m_pd3d11device->CreateVertexShader(
...
//		);
//
//		pgpudevice->m_pd3d11device->CreatePixelShader(
...
//
//		pgpudevice->m_pd3d11device->CreateSamplerState(&sampDesc, &m_psamplerstateLinear);
//
...
//
//
//	::i32 swap_chain_render_target_view::get_image_index() const
//	{
//
...
//
//		// 1. Set render target
//		pgpudevice->m_pd3d11devicecontext->OMSetRenderTargets(1, pgpudevice->m_prendertargetviewBackBuffer.pp(), nullptr);
//
//		// 2. Set viewport
//		D3D11_VIEWPORT vp = {};
//		vp.TopLeftX = 0;
...
//		vp.MinDepth = 0.0f;
//		vp.MaxDepth = 1.0f;
//		pgpudevice->m_pd3d11devicecontext->RSSetViewports(1, &vp);
//
//		// 3. Bind shaders
//		pgpudevice->m_pd3d11devicecontext->VSSetShader(m_pvertexshaderFullscreen, nullptr, 0);
//		pgpudevice->m_pd3d11devicecontext->PSSetShader(m_ppixelshaderFullscreen, nullptr, 0);
//
//		// 4. Bind SRV and sampler
//		pgpudevice->m_pd3d11devicecontext->PSSetShaderResources(0, 1, m_pshaderresourceviewShader.pp());
//		pgpudevice->m_pd3d11devicecontext->PSSetSamplers(0, 1, m_psamplerstateLinear.pp());
//
//		// 5. Draw fullscreen triangle (no vertex buffer needed)
//		pgpudevice->m_pd3d11devicecontext->IASetPrimitiveTopology(D3D11_PRIMITIVE_TOPOLOGY_TRIANGLELIST);
//		pgpudevice->m_pd3d11devicecontext->Draw(3, 0);
//
