...
//      ::point_f64 move_to(double x, double y) override;
      ...
      void polydraw(const ::point_f64* ppoints, const ::u8* lpTypes, ::collection::count nCount) override;
      void polyline_to(const ::point_f64* ppoints, ::collection::count nCount) override;
      void poly_polyline(const ::point_f64* ppoints, const ::i32 * lpPolyPoints, ::collection::count nCount) override;
