...
namespace draw2d_directx11
{
   ...
   ID2D1Geometry * region::get(::draw2d::graphics* pgraphics)
   {
      ...
      case ::draw2d::e_region_none:
      {
         ...
         HRESULT hr = ::draw2d_directx11::plugin::d2d1_factory1()->CreatePathGeometry(&ppathgeometry);
   ...
   ID2D1Geometry * region::get_rect(::draw2d::graphics* pgraphicsParam)
   {
      ...
      ::draw2d_directx11::plugin::d2d1_factory1()->CreateRectangleGeometry(r, &pgeometry);
   ...
   ID2D1Geometry * region::get_oval(::draw2d::graphics* pgraphics)
   {
      ...
      ::draw2d_directx11::plugin::d2d1_factory1()->CreateEllipseGeometry(ellipse, &pgeometry);
