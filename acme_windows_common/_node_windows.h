...
//i32 CLASS_DECL_ACME __windows_main(class ::system * psystem, ::create * pmaininitdata);
...
//CLASS_DECL_ACME i32 app_main(class ::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, char * pCmdLine, ::e_display edisplay);
