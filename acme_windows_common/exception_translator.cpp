...
//            {
//
//               output_debug_string("failed to install floating i32_point exception signal handler");
//
//            }
//
//            zero(m_sig.m_saPipe);
...
//#endif
   ...
   const_char_pointer exception_translator::_get_standard_exception_name(::u32 uiCode)
   {
   ...
   const_char_pointer exception_translator::_get_standard_exception_description(::u32 uiCode)
   {
      ...
      case EXCEPTION_FLT_DENORMAL_OPERAND:
         pszDescription = "One of the operands in a floating-i32_point operation is denormal. A denormal value is one that is too small to represent as a standard floating-i32_point value";
         break;
      case EXCEPTION_FLT_DIVIDE_BY_ZERO:
         pszDescription = "The thread attempted to divide a floating-i32_point value by a floating-i32_point divisor of zero";
         break;
      case EXCEPTION_FLT_INEXACT_RESULT:
         pszDescription = "The result of a floating-i32_point operation cannot be represented exactly as a decimal fraction";
         break;
      case EXCEPTION_FLT_INVALID_OPERATION:
         pszDescription = "This exception represents any floating-i32_point exception not included in this list_base";
         break;
      case EXCEPTION_FLT_OVERFLOW:
         pszDescription = "The exponent of a floating-i32_point operation is greater than the magnitude allowed by the corresponding type";
         break;
      case EXCEPTION_FLT_STACK_CHECK:
         pszDescription = "The stack overflowed or underflowed as the result of a floating-i32_point operation";
         break;
      case EXCEPTION_FLT_UNDERFLOW:
         pszDescription = "The exponent of a floating-i32_point operation is less than the magnitude allowed by the corresponding type";
         break;
