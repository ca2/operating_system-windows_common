...
namespace draw2d_directx
{
   ...
   bool graphics::CreateCompatibleDC(::draw2d::graphics *)
   {
      ...
      /*pdraw2d->directx() = __new(::draw2d_directx::plugin);

      pdraw2d->directx()->initialize();*/
   ...
   bool graphics::_draw_blend(const ::image_drawing & imagedrawing)
   {
      ...
      //      __pointer(::draw2d_directx::graphics) pgraphicsDib1 = pimage1->get_graphics();

      //      __pointer(::draw2d_directx::graphics) pgraphicsDib2 = pimage2->get_graphics();
...
//   bool graphics::draw(const ::rectangle_f64 & rectangleTarget, ::draw2d::icon * picon)
//   {
//
//#ifdef _UWP
//
...
//
   ...
   bool graphics::round_rectangle(const ::rectangle_f64 & rectParam, double dRadius)
   {
      ...
      if (m_pbrush.is_set() && m_pbrush->m_etype != ::draw2d::brush::e_type_null)
      {
         ...
         auto pbrush = m_pbrush.cast <::draw2d_directx::brush > ();
      ...
      if (m_pbrush.is_set() && m_pbrush->m_etype != ::draw2d::brush::e_type_null)
      {
         ...
         auto ppen = m_ppen.cast <::draw2d_directx::pen >();
   ...
   bool graphics::_stretch_raw(const ::rectangle_f64 & rectangleTarget, ::image * pimage, const image_drawing_options & imagedrawingoptions, const ::rectangle_f64 & rectangleSource)
   {
      ...
      try
      {
         ...
         else
         {
            ...
            output_debug_string("directx graphics::StretchBltRaw hr failed");
   ...
   //bool graphics::_draw_raw(const ::rectangle_f64 & rectangleTarget, ::draw2d::graphics * pgraphicsSrc, const ::point_f64 & pointSrc)
   //{
   ...
   //bool graphics::_stretch_raw(const ::rectangle_f64 & rectangleTarget, ::draw2d::graphics * pgraphicsSrc, const ::rectangle_f64 & rectangleSource)
   //{
...
//   }
   ...
   bool graphics::fill_path()
   {
      ...
      //return m_prendertarget->FillPath(directx_brush(), m_ppath) == Gdiplus::Status::Ok;
   ...
   bool graphics::stroke_and_fill_path()
   {
      ...
      //bool bOk1 = m_prendertarget->FillPath(directx_brush(), m_ppathPaint) == Gdiplus::Status::Ok;

      //bool bOk2 = m_prendertarget->DrawPath(directx_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
...
//      return m_prendertarget->DrawPath(directx_pen(), m_ppathPaint) == Gdiplus::Status::Ok;
   }
...
//      return m_ppath->Widen(directx_pen()) == Gdiplus::Status::Ok;
   }
   ...
   //      //dynamic_cast <::draw2d_directx::graphics *> (pgraphicsSrc)->SaveClip();
   ...
   //         //dynamic_cast <::draw2d_directx::graphics *> (pgraphicsSrc)->RestoreClip();
...
//   {
                                           ...
                                           HANDLETABLE* pHandleTable, METARECORD* pMetaRec, double dHandles, LPARAM lParam)
   {
      ...
      case META_SETMAPMODE:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SetMapMode((int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWEXT:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->set_window_ext(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETWINDOWORG:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SetWindowOrg(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTEXT:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SetViewportExt(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SETVIEWPORTORG:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SetViewportOrg(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEWINDOWEXT:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->scale_window_ext(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SCALEVIEWPORTEXT:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->ScaleViewportExt(
         (int)(short)pMetaRec->rdParm[3], (int)(short)pMetaRec->rdParm[2],
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_OFFSETVIEWPORTORG:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->OffsetViewportOrg(
         (int)(short)pMetaRec->rdParm[1], (int)(short)pMetaRec->rdParm[0]);
         break;
      case META_SAVEDC:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SaveDC();
         break;
      case META_RESTOREDC:
         (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->RestoreDC((int)(short)pMetaRec->rdParm[0]);
         break;
      ...
      case META_SELECTOBJECT:
      {
         ...
         if (nObjType == 0)
         {
            ...
            HFONT hFontOld = (HFONT)::SelectObject((dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->get_handle1(), hStockFont);
            HGDIOBJ hObjOld = ::SelectObject((dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->get_handle1(), hObject);
            if (hObjOld == hStockFont)
            {
               // got the stock object back, so must be selecting a font
               __throw(error_not_implemented);
               //                  (dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->SelectObject(::draw2d_directx::font::from_handle_dup(pgraphics->get_application(), (HFONT)hObject));
               break;  // don't play the default record
            }
            else
            {
               // didn't get the stock object back, so restore everything
               ::SelectObject((dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->get_handle1(), hFontOld);
               ::SelectObject((dynamic_cast<::draw2d_directx::graphics * >(pgraphics))->get_handle1(), hObjOld);
            }
   ...
   bool graphics::get_text_extent(size_f64 & size, const ::string & lpszString, strsize nCount, strsize iIndex)
   {
      ...
      hr = pdraw2d->directx()->dwrite_factory()->CreateTextLayout(
   ...
   bool graphics::draw_line(double x1, double y1, double x2, double y2, ::draw2d::pen * ppen)
   {
      ...
      m_prendertarget->DrawLine(p1, p2, pbrush, (FLOAT)(dynamic_cast < ::draw2d_directx::pen * > (m_ppen.m_p))->m_dWidth);
   ...
   bool graphics::line_to(double x, double y)
   {
      ...
      FLOAT fWidth = (FLOAT)(dynamic_cast <::draw2d_directx::pen *> (m_ppen.m_p))->m_dWidth;
...
//                                            );
//
//      HRESULT hr = ::draw2d_directx::plugin::d2d1_factory1()->CreateDCRenderTarget(&props,&m_pdcrendertarget);
//
//      if (FAILED(hr))
//      {
//
...
//#endif
   ...
   bool graphics::draw(const ::text_out & textout, ::draw2d::pen * ppen)
   {
      ...
      IDWriteFactory * pfactory = pdraw2d->directx()->dwrite_factory();
      ...
      CustomTextRenderer renderer(::draw2d_directx::plugin::d2d1_factory1(),m_prendertarget.Get(),ppen->get_os_data < ID2D1Brush * >(this));
   ...
   bool graphics::fill(const ::text_out & textout, ::draw2d::brush * pbrush)
   {
      ...
      if (posbrush)
      {
         ...
         CustomTextRenderer renderer(::draw2d_directx::plugin::d2d1_factory1(), m_prendertarget.Get(), nullptr, posbrush);
   ...
   //void graphics::set_directx_plugin(::draw2d_directx::plugin * pplugin)
   //{

   //   pdraw2d->directx() = pplugin;
