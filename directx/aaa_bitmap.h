...
namespace draw2d_directx
{
   ...
   public:
      ...
      virtual bool CreateBitmap(::draw2d::graphics * pgraphics, const ::size_i32& size, unsigned int nPlanes, unsigned int nBitcount, const void * lpBits, int stride) override;
