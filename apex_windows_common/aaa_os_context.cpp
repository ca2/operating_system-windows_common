...
CLASS_DECL_APEX_WINDOWS_COMMON HBITMAP get_icon_hbitmap(HICON hICON);
...
namespace windows
{
   ...
   bool os_context::file_association_set_shell_open_command(const ::scoped_string & scopedstrExtension, const ::scoped_string & scopedstrExtensionNamingClass,  const ::i8 * pszCommand, const ::scoped_string & scopedstrParam)
   {
...
retry:
   ...
   bool os_context::enable_service(const ::scoped_string & scopedstrServiceName,const ::scoped_string & scopedstrDisplayName,const ::scoped_string & scopedstrCommand,const ::scoped_string & scopedstrUser,const ::scoped_string & scopedstrPass)
   {
   ...
   bool os_context::disable_service(const ::scoped_string & scopedstrServiceName)
   {
...
repeat:
   ...
   bool os_context::browse_file_save(::property_set & set)
   {
      ...
      //   pinteraction->display(e_display_normal, CCXXXe_activation_set_foreground);
...
namespace windows
{
   ...
   namespace apex
   {
      ...
      void node::shell_create_link(::file::path pathObj, ::file::path pathLnk, string strDesc, ::file::path pathIco, ::i32 iIcon)
      {
