...
//   CLASS_DECL_APEX_WINDOWS_COMMON ::i32        reg_query_value(HKEY hkey, const ::scoped_string & scopedstrSubKey,string & str);
//
//   CLASS_DECL_APEX_WINDOWS_COMMON HICON       extract_icon(HINSTANCE hInst, const ::scoped_string & scopedstrExeFileName,::u32 nIconIndex);
//
...
//} // namespace windows
//
//CLASS_DECL_APEX_WINDOWS_COMMON ::i32 delete_registry_tree_helper(HKEY hParentKey,const ::scoped_string & scopedstrKeyName);
//
//
...
CLASS_DECL_APEX_WINDOWS_COMMON ::i32 app_main(::apex::system * psystem, HINSTANCE hInstance, HINSTANCE hPrevInstance, ::i8 * pCmdLine, ::e_display edisplay);
