...
namespace direct2d_directx11
{
   ...
   void direct2d_directx11::initialize(::particle * pparticle)
   {
   ...
   comptr<ID2D1Device> direct2d_directx11::create_device(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   IDWriteFactory * direct2d_directx11::dwrite_factory(bool bCreate)
   {
   ...
   ID2D1Factory1 * direct2d_directx11::d2d1_factory1(bool bCreate)
   {
   ...
   ID2D1Device * direct2d_directx11::d2d1_device(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   ID2D1DeviceContext* direct2d_directx11::default_d2d1_device_context(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   comptr<ID2D1DeviceContext> direct2d_directx11::create_d2d1_device_context(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {
   ...
   ID2D1DeviceContext* direct2d_directx11::default_d2d1_device_context()
   {
   ...
   comptr < ID2D1PathGeometry1 > direct2d_directx11::create_rectangle_path_geometry(const ::double_rectangle & rectangle)
   {
   ...
   CLASS_DECL_DIRECT2D_DIRECTX11 void defer_initialize(::windowing::window* pwindow, const ::int_rectangle& rectanglePlacement)
   {

      if (::is_set(direct2d_directx11::s_pdirect2d))
      {
...
CLASS_DECL_DIRECT2D_DIRECTX11 DWRITE_FONT_WEIGHT dwrite_font_weight(const write_text::font_weight & fontweight)
{
...
direct2d_directx11_lock::direct2d_directx11_lock()
{

   auto pdirect2d = ::direct2d_directx11::get();
...
direct2d_directx11_lock::~direct2d_directx11_lock()
{
   ...
   if (m_bLocked)
   {
      ...
      ::direct2d_directx11::direct2d_directx11::s_pdirect2d->m_pd2d1multithread->Leave();
