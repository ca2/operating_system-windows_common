...
namespace direct2d_directx11
{
   ...
   class CLASS_DECL_DIRECT2D_DIRECTX11 direct2d_directx11 :
   ...
   inline direct2d_directx11* get()
   {

      return direct2d_directx11::s_pdirect2d;
...
class CLASS_DECL_DIRECT2D_DIRECTX11 direct2d_directx11_lock
{
public:
