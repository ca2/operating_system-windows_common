...
#include "draw2d_direct2d/path.h"
//#include "object.h"
...
namespace draw2d_direct2d_for_directx11
{
   ...
   class CLASS_DECL_DRAW2D_DIRECT2D_FOR_DIRECTX11 path :
      virtual public ::draw2d_direct2d::path//,
//      virtual public ::draw2d::path
   ...
   public:
      ...
      //virtual bool internal_add_string(::draw2d_direct2d_for_directx11::graphics * pdraw2dgraphics, ::f64 x, ::f64 y, const ::scoped_string & scopedstrText, ::write_text::font * pwritetextfont);
