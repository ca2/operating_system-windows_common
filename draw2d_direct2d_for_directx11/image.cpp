...
namespace draw2d_direct2d_for_directx11
{
   ...
   void image::create_gpu_texture_image(::gpu::texture * pgputexture, ::gpu::graphics * pgpugraphics)
   {
      ...
      ::cast < ::draw2d_direct2d_for_directx11::bitmap > pdraw2ddirect2dfordirectx11bitmap = pdraw2dbitmap;

      ::cast < ::draw2d_direct2d_for_directx11::graphics > pdraw2dgraphics = pgpugraphics;
...
//   }
   ...
   void image::update_as_gpu_render_target(const ::i32_size & sizeRaw, ::user::interaction * puserinteraction, ::draw2d::graphics * pdraw2dgraphics, ::enum_flag eflagCreate, ::i32 iStride, bool bPreserve, bool bTopDraw2d)
   {
      ...
      pdraw2ddirect2dfordirectx11bitmap->create_gpu_bitmap(pdraw2dgraphics, sizeRaw);

      m_pdraw2dbitmap = pdraw2dbitmap;

      //::cast <::draw2d_direct2d_for_directx11::graphics > pdraw2dgraphics = m_pgraphicsOwned;
   ...
   bool image::_create(::draw2d::graphics * pdraw2dgraphics)
   {
      ...
      ::draw2d::bitmap * pdraw2dbitmap = dynamic_cast<::draw2d_direct2d_for_directx11::graphics *>(pdraw2dgraphics)->get_current_bitmap();
...
//#endif
   ...
   //   //   ::draw2d_direct2d_for_directx11::graphics * pdraw2dgraphics = dynamic_cast <::draw2d_direct2d_for_directx11::graphics *> (get_graphics());
