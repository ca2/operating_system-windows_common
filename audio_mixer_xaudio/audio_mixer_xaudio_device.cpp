   ...
   namespace audio_mixer_mmsystem
   {
      ...
      void     device::open(::u32 uiMixerId, ::u32 dwCallback, ::u32 dwInstance, ::u32 fdwOpen)
      {
         ...
         if (m_hMixer != nullptr)
         {
            ...
            if(::success != mmrct)
            {
               ...
               message_box(nullptr, ::user::e_message_box_ok | ::user::e_message_box_icon_exclamation, "mixerClose() failed on hmx=%.04Xh, mmr=%u!", m_hMixer, mmrct);
         ...
         if(::success != mmrc)
         {
            ...
            message_box(nullptr, ::user::e_message_box_ok | ::user::e_message_box_icon_exclamation, "mixerGetDevCaps() failed on uMxId=%u, mmr=%u!", uiMixerId, mmrc);
         ...
         if(::success != mmrc)
         {
            ...
            message_box(nullptr, ::user::e_message_box_ok | ::user::e_message_box_icon_exclamation, "mixerOpen() failed on uMxId=%u, mmr=%u!", uiMixerId, mmrc);
         ...
         //    Appset_window_text(oswindow, "::audio_mixer::audio_mixer Device: %s", (::i8 *)mxcaps.szPname);
      ...
      void     device::initialize_capabilities()
      {
         ...
         if(::success != mmrc)
         {
            ...
            message_box(nullptr, ::user::e_message_box_ok | ::user::e_message_box_icon_exclamation, "mixerGetDevCaps() failed on uMxId=%u, mmr=%u!", m_uiMixerID, mmrc);
      ...
      void device::OnMixerLineChange(::u32 dwLineID)
      {
         ...
         if(m_mapIDToLine.find(dwLineID, pSource))
         {
      ...
      void device::OnMixerControlChange(::u32 dwControlID)
      {
         ...
         if(m_mapIDToControl.find(dwControlID, pControl))
         {
      ...
      bool device::OnCommand(wparam wparam, lparam lparam)
      {
         ...
         if(m_mapDlgItemIDToControl.find(uiID, pinteraction)
