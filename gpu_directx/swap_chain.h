...
namespace gpu_directx
{
   ...
   public:
...
#endif
      /* Set the DirectX objects required for swapchain creation and management, must be called before swapchain creation */
      ...
      */
      ...
      /* Free all DirectX resources acquired by the swapchain */
      void cleanup();
