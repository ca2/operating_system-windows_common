...
void context_fbo::on_initialize_particle()
{
   ...
   ::directx::context::on_initialize_particle();
   ...
   void context_fbo::_create_offscreen_buffer(const ::int_size & sizeParam)
   {
      ...
      this->post([this, size]()
         ...
         CGLPixelFormatAttribute AttribList[] =
         {
            ...
            //         kCGLPFADirectXProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            ...
            //
            //kCGLPFADirectXProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL4_Core,
            kCGLPFADirectXProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_Core,
            //         kCGLPFADirectXProfile, (CGLPixelFormatAttribute)kCGLOGLPVersion_GL3_2_Core,
         ...
         //auto displayMask= CGDisplayIDToDirectXDisplayMask (display);
