...
namespace gpu_directx
{
   ...
   class CLASS_DECL_GPU_DIRECTX context :
...
//      directx::QueueFamilyIndices m_queuefamilyindices;
//      //struct
//      //{
//      //   uint32_t graphics;
//      //   uint32_t compute;
...
//      //VkSurfaceKHR m_vksurfacekhr;
      ...
      //::gpu_directx::descriptor_pool* get_global_pool(int iFrameCount);
   ...
   /*   virtual void translate_shader(string & str);
      ...
      //virtual VkDescriptorSet getGlobalDescriptorSet(::gpu_directx::renderer* prenderer);

      ::gpu_directx::descriptor_pool* get_global_pool(int iFrameCount);


      ////set_descriptor_layout* get_set_descriptor_layout(::gpu::context * pgpucontext);
      //virtual VkDescriptorSet getGlobalDescriptorSet(::gpu::context* pgpucontext, ::gpu_directx::renderer* prenderer);

      //::gpu_directx::descriptor_pool* get_global_pool(::gpu::context* pgpucontext, int iFrameCount);
