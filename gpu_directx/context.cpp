...
//int iError18 = glGetError();
   ...
   void context::_create_offscreen_window(const ::int_size & size)
   {
      ...
      //   LPCTSTR lpClassName = L"draw2d_directx_offscreen_buffer_window";
      //   LPCTSTR lpWindowName = L"draw2d_directx_offscreen_buffer_window";
      ...
      //   HMENU hMenu = nullptr;
      //   HINSTANCE hInstance = ::GetModuleHandleW(L"gpu_directx.dll");
...
//   }
   ...
   //      ::pointer < ::directx::directx > pdirectx = pgpu;

   //      if (!pdirectx->m_atomClass)
   //      {
   ...
   //      //xxxopengl>>>>directx PIXELFORMATDESCRIPTOR pixformat;
   ...
   //      ////xxxopengl>>>>directx  zero(pixformat);
   //      //pixformat.nSize = sizeof(pixformat);
   //      //pixformat.nVersion = 1;
   //      //pixformat.dwFlags = PFD_DRAW_TO_WINDOW | PFD_SUPPORT_DIRECTX | PFD_DOUBLEBUFFER;
   ...
   //      //xxxopengl>>>>directx chosenformat = ChoosePixelFormat(hdc, &pixformat);
   ...
   //      pdirectx->defer_init_gpu_library();
   ...
   void context::defer_create_window_context(::windowing::window * pwindow)
   {
      ...
      //::directx::context::defer_create_window_context(pwindow);
   ...
   ////context::context(::graphics3d_directx::DirectXDevice* pgpudevice) : this->logicalDevice(){pgpudevice->logicalDevice} {
   //context::context()
   //{
   ...
   ::gpu_directx::descriptor_pool* context::get_global_pool(int iFrameCount)
   {
