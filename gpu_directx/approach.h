...
namespace gpu_directx
{
   ...
   class CLASS_DECL_GPU_DIRECTX approach :
   ...
   public:
      ...
      //VkQueue                          m_vkqueue;
      //// Depth buffer format (selected during DirectX initialization)
...
//      ::array<VkFence>                 m_fencewaita;
      ...
      /** @brief Encapsulated physical and logical directx device */
...
//#endif
      ...
      //__creatable_from_base(directx, ::gpu::approach);
      ...
      //::pointer<::directx::buffer>  m_pbuffer;
      //::pointer<::directx::program> m_pprogram;
      //unsigned int                  VAO;
      //unsigned int                  VBO;
