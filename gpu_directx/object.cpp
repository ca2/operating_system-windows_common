...
const char * directx_error_string(int iError)
{
...
//      {
//       
//         pszErrorN = (const char *)directx_error_string(iErrorN);
//
//      }
//
//#ifdef __APPLE__
...
//      auto pszError2 = (const char *)directx_error_string(iError2);
//      if(pszError2)
//      {
//         
...
//      auto pszErrorA = (const char *)directx_error_string(iErrorA);
//      if(pszErrorA)
//      {
//         
...
//      auto pszError1 = (const char *) directx_error_string(iError1);
//      if(pszError1)
//      {
//         
...
//      auto pszError5 = (const char *)directx_error_string(iError5);
//      if(pszError5)
//      {
//         
...
//      auto pszError4 = (const char *)directx_error_string(iError4);
//      if(pszError4)
//      {
//         
