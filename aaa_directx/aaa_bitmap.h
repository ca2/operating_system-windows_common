...
namespace draw2d_directx
{
   ...
   public:
      ...
      virtual bool CreateBitmap(::draw2d::graphics * pgraphics, const ::i32_size& size, unsigned int nPlanes, unsigned int nBitcount, const void * lpBits, int stride) override;
      ...
      virtual bool create_bitmap(::draw2d::graphics * pgraphics, const ::i32_size & size, void **ppvBits, int * stride) override;
