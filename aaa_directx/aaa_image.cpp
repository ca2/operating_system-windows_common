...
namespace draw2d_directx
{
   ...
   bool image::_create(::draw2d::graphics* pgraphicsParam)
   {
      ...
      ::draw2d::bitmap * pbitmap = dynamic_cast<::draw2d_directx::graphics *>(pgraphicsParam)->get_current_bitmap();
  ...
  bool image::_draw_raw(const ::i32_rectangle & rectangleTarget, ::image::image * pimage, const ::i32_point & pointSrc)
   ...
   bool image::_unmap()
   {
      ...
      if (SUCCEEDED(m_hrEndDraw))
      {
         ...
         ///dynamic_cast <::draw2d_directx::graphics *> (((image *) this)->m_pgraphics.m_p)->RestoreClip();
   ...
   bool image::realize(::draw2d::graphics *) const
   {
      ...
      ::pointer<::draw2d_directx::graphics>pgraphicsMap = m_pgraphicsMap;

      ::pointer<::draw2d_directx::graphics>pgraphics = m_pgraphics;
   ...
   bool image::blend(const ::i32_point & pointDst, ::image::image * pimageSrc, const ::i32_point & pointSrc, const ::i32_size & sizeParam, unsigned char bA)
   {
      ...
      //   ::draw2d_directx::graphics * pgraphics = dynamic_cast <::draw2d_directx::graphics *> (get_graphics());
      ...
      //      //dynamic_cast <::draw2d_directx::graphics *> (pgraphicsMap)->RestoreClip();
