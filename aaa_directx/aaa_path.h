...
namespace draw2d_directx
{
   ...
   class CLASS_DECL_DRAW2D_DIRECTX path :
   ...
   public:
      ...
      virtual bool internal_add_string(::draw2d_directx::graphics * pgraphics, ::f64 x, ::f64 y, const ::scoped_string & scopedstrText, ::write_text::font * pfont);
